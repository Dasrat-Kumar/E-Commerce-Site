...
//                   <p className="insight-value blue">$0.00</p>
//                   <span>Average Order Value</span>
//                 </div>
//                 <div className="insight-item">
//                   <p className="insight-value green">0%</p>
//                   <span>Order Fulfillment Rate</span>
//                 </div>
//                 <div className="insight-item">
//                   <p className="insight-value purple">320</p>
          ...
          <>
            ...
            <div className="insights-card">
              ...
              <div className="insights-grid">
                ...
                <div className="insight-item">
                  <p className="insight-value purple">{metrics.products * 1 }</p>
                  <span>Total Inventory</span>
                </div>
              </div>
            </div>
